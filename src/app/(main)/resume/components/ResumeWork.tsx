...
function ExperienceDurationPill() {
  return (
    <Pill
      name={`${
        ((experience) =>
          formatExperienceText(experience.years, experience.months))(
          calculateTotalExperience([
            { startDate: "2024-01-08", endDate: "2026-03-08" },
        ...
        <div className="md:grid md:grid-cols-4 md:gap-x-6">
          ...
          <div className="col-span-3 space-y-6 pt-4">
            ...
            <article className="space-y-3">
              ...
              <p className="pl-4 text-base font-bold text-muted-foreground">
                드론·지상 촬영 이미지를 사진측량 기반으로 정사영상 지도, 3D 모델,
                포인트클라우드를 생성·시각화하는 클라우드 플랫폼
              </p>
              <div className="space-y-4 pl-4">
                <section className="space-y-2">
                  <h4 className="text-base font-semibold text-foreground">
