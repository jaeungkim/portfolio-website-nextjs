    ...
    <section className="grid gap-y-5 sm:gap-y-6 md:grid-cols-[clamp(180px,24vw,220px)_minmax(0,1fr)] md:gap-x-8 lg:gap-x-10">
      ...
      <div className="max-w-[72ch] space-y-3 text-left text-[15.5px] leading-7 text-muted-foreground">
        <p>
          ...
          프론트엔드 개발자입니다. 웹 서비스의 기획과 설계부터 개발, 배포 및
          운영까지 전반적인 과정을 경험하며 꾸준히 성장해왔습니다.
        </p>
        <p>
          저는 단순히 화면을 구현하는 것에 그치지 않고, 코드의 구조와 흐름을
          이해하며 서비스의 완성도를 높이는 데 집중하는 개발자입니다. 누구나
          쉽게 이해하고 유지보수할 수 있는 명확한 코드를 작성하는 것을
          중요하게 생각하며, 견고하고 효율적인 구조를 만들기 위해 항상 고민하고
          있습니다.
        </p>
        <p>
          또한 완성도 높은 결과물을 만들기 위한 집요함을 제 강점이라고
          생각합니다. 다만 빠르게 변화하는 개발 환경 속에서 완벽함만을
          추구하기보다는, 우선순위를 명확히 설정해 핵심 기능을 안정적으로
          구현하고 이후 구조적인 개선을 지속적으로 발전시키는 방식으로 균형을
          맞추고 있습니다.
        </p>
        <p>
          개발은 혼자 완성하는 일이 아니라 함께 만들어가는 과정이라고
          생각합니다. 프로젝트의 방향성과 문제 상황을 투명하게 공유하고,
          동료들과의 기술적 논의와 협업을 통해 더 나은 해결책을 찾는 것을
          중요하게 여기고 있습니다.
        </p>
        <p>
          앞으로도 꾸준한 학습과 경험을 통해 더 높은 수준의 기술적 완성도를
          갖춘 프론트엔드 개발자로 성장해 나가겠습니다.
        </p>
      </div>
    </section>
  );
