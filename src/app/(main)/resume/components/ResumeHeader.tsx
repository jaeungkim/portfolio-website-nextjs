    ...
    <section className="grid gap-y-6 md:grid-cols-[clamp(180px,24vw,220px)_minmax(0,1fr)] md:gap-x-8 lg:gap-x-10">
      ...
      <div className="flex max-w-[72ch] flex-col gap-5">
        ...
        <div className="space-y-3 text-sm leading-relaxed text-foreground">
          <p>
            안녕하세요. 5년차 엔지니어 김재웅 입니다. 복잡한 도메인의 데이터에
            의미를 부여하고, 사람이 그 의미를 따라 길을 잃지 않도록 환경을
            설계하는 일에 가치를 둡니다. 좋은 설계는 복잡함을 줄이는 일이
            아니라, 사람이 그 안에서도 길을 잡을 수 있게 만드는 일이라고 봅니다.
          </p>
          <p>
            데이터가 도메인 지식으로 정제되는 과정과, 그 위에서 사람과 AI가
            어떻게 협업할 수 있는지를 주로 고민합니다. 사소한 어긋남을 그냥 두지
            않고, 좋은 결과물은 좋은 협업에서 나온다고 믿습니다.
          </p>
          <p>
          ...
          <p>
            개발자 경험과 사용자 경험처럼, 기술과 사람이 맞닿는 표면을 다듬는
            일에 특히 공을 들입니다.
          </p>
        </div>
      </div>
