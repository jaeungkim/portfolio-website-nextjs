...
//             className={`mx-2 px-4 py-2 text-sm font-medium rounded-full ${activeTab === category.toLowerCase()
//               ? "text-white"
...
//                   className={`mx-2 my-1 px-3 py-1 border rounded-full text-sm font-medium ${selectedTags.includes(tag)
